...
left_comp_ip = '' #тут має бути айпишка з консольки
middle_comp_ip = '' #тут має бути айпишка з консольки
right_comp_ip = '' #тут має бути айпишка з консольки
...
RIGHT_PAD = c.create_line(WIDTH - RIGHT_PAD_W / 2, 0, WIDTH - RIGHT_PAD_W / 2,
                          RIGHT_PAD_H, width=RIGHT_PAD_W, fill="white")
